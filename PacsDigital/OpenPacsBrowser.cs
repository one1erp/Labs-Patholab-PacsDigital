...
{
    public partial class OpenPacsBrowser : UserControl
    {
        private SDG _sdg;
        ...
        private void pacsDigital_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_sdg != null)
                {
                    ...
                    {
                        Logger.WriteLogFile($"pacsDigital_Click \n {url}");
